...
│   ├── creacion_valor_plantel.ipynb       # Procesamiento de atributos EA FC 2026
...
│   └── recomendacion_pca_negativos_documentado.py
├── requirements.txt
└── README.md
```
...
- **Bloque ELO:** `ELO_match_rating` (calidad agregada) y `ELO_diff` (disparidad competitiva)
